...
export default function LandingPage() {
  ...
  return (
    <div style={{
      ...
      {/* NAV */}
      <nav className="nav">
        <Link href="/" className="nav-logo" style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}><img src="/brand/civicwatch-shield-dark.svg" alt="" width={28} height={28} style={{ display: 'block' }} /><span style={{ color: 'inherit' }}>CIVIC<span>WATCH</span></span></Link>
