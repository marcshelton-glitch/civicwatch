...
**Status: LIVE** · Repo: `/Users/marcshelton/civicwatch` · Last updated: June 6, 2026
...
- [ ] Run `python3 ~/civicwatch/_push.py` on Mac to push the 10 P3 QA fixes from June 5
...
- [ ] Connect civicwatch folder in Cowork settings (fixes automated task file writing)
...
*File built from: Product Spec Sheet (June 2026) + live site audit of civicwatch.app + full session transcript OCR (11 screenshots, March–June 2026) · Last rebuilt: June 6, 2026*
