        ...
        headers: [
          ...
          { key: 'X-XSS-Protection', value: '1; mode=block' },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.supabase.co https://api.clerk.dev https://clerk.civicwatch.app https://*.clerk.com https://vercel.live https://cdn.jsdelivr.net https://www.govtrack.us https://api.mobilize.us https://cicero.azavea.com https://api.stripe.com",
