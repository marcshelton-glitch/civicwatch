...
// CivicWatch has two tiers: free and pro. voter_pro / civic_pack are legacy
// values from the California Candidate Calculator's model — retained so any
// account still carrying one keeps a working cap. See lib/tier-utils.js.
const SPEND_CAPS = {
  free: 2000,
  pro: 50_000,
  civic_pack: 50_000, // legacy → pro
  voter_pro: 50_000,  // legacy → pro
}
